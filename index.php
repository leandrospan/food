...
<body>
    ...
    <div class="order" id="Order">
        ...
        <div class="order_main">
            ...
            <form action="index.php" method="post">
                ...
                <div class="input">
                    <p>Name</p>
                    <input type="text" placeholder="you name" name="nome">
                </div>
                ...
                <div class="input">
                    <p>Number</p>
                    <input placeholder="you number" name="celular">
                </div>

                <div class="input">
                    <p>How Much</p>
                    <input type="number" placeholder="how many order" name="quantidade">
                </div>

                <div class="input">
                    <p>You Order</p>
                    <input placeholder="food name" name="prato">
                </div>

                <div class="input">
                    <p>Address</p>
                    <input placeholder="you Address" name="endereco">
                </div>
    ...
    */
    ...
    $nome = $email = $celular = $quantidade = $prato = $endereco = "";
    ...
    $sql = "INSERT INTO cliente (nome, email, celular, quantidade, prato, endereco) VALUES ('$nome', '$email', '$celular', '$quantidade', '$prato', '$endereco')";
